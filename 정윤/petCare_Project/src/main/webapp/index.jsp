				...
				<main>
					<div class="inside">
						...
						<div class="service_menu">
							...
							<div class="word2">
								고객님과의 원활한 소통을 통해 모든 서비스의 신뢰를 보장합니다. <br> 숙련된 펫매니저들의 최상의 서비스를 제공하고 있습니다. 
							</div>
						</div>
						<div class="empty space"></div>
						<div class="doz_row">
				...
				<div class="row to-animate">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<blockquote>
									<p>&ldquo;산책 서비스를 몇번 받았더니 우리 아이가 자꾸
									산책시켜달라고 졸라요 살려주세요... &rdquo;</p>
									<p class="quote-author">&mdash; 최효정</p>
								</blockquote>
							</li>
							<li>
								<blockquote>
									<p>&ldquo;처음 반려동물을 키워 보는 거라 모르는 부분이 많았는데, <br>직원분이 이것저것 친절하게 잘 알려주셔서 되게 고마웠어요!&rdquo;</p>
									<p class="quote-author">&mdash; 신예원</p>
								</blockquote>
							</li>
							<li>
								<blockquote>
									<p>&ldquo;말도 잘 안듣고 사나운 애가 펫시터의 말을 잘들을까? 걱정했는데
									얌전하게 말잘들어서 깜짝 놀랐어요.다음에도 이용할게용~&rdquo;</p>
