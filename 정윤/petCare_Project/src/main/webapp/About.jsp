			...
			<main>
				...
				<div class="text-table">
					<div>
						...
						<p style="color: black; margin-top: 15px; opacity: 0.8;">
							<span><span style="font-size: 26px;">산책, 목욕, 미용까지
									우리아이의 모든 케어를&nbsp;</span></span>
						</p>
						<p style="color: black; margin-top: 15px; opacity: 0.8;">
				...
				<div id="fh5co-about" data-section="about">
					...
					<div class="fh5co-2col fh5co-text">
						...
						<p class="to-animate">
							<span class="firstcharacter" style="margin: 40px 0px;">믿고 기댈 수 있는 또 다른 가족</span>
						<div
					...
					<div class="inside">
						...
						<div class="about_tilte">
							<p style="text-align: center;">
								<img src="images/about_img_1.png"
									style="width: 30px; margin: auto;" alt="">
							</p>
							<h5 style="text-align: center;">
								<span style="font-size: 30px;"><strong>이런 분들에게
										추천드려요!</strong></span>
							</h5>
						</div>
						<div class="empty"></div>
									...
									<div class="item_wrap">
										...
										<div class="item_overlay">
											<div class="item_pay">
												<div class="text-table">
													<p>
														<span style="font-size: 22px;"><strong>반려동물을
																위한 전문가의 1:1맞춤케어를 원하시는분</strong></span>
													</p>
												</div>
												<hr
													style="border-top-width: 1px; border-color: rgba(0, 0, 0, 0.06);">
											</div>
											<p class="index_care">반려견은 동일한 메니저에게 케어를 받아야 정서적으로 더 좋으며
												반려견의 세세한 성격, 습성같은 부분을 잘인지한 메니저일 수록 더욱 데테일한 케어가 가능합니다.</p>
										</div>
									</div>
								</div>
									...
									<div class="item_wrap">
										...
										<div class="item_overlay">
											<div class="item_pay">
												<div class="text-table">
													<p>
														<span style="font-size: 22px;"><strong>유동적인
																일정때문에 미용샵 예약이 어려우신분</strong></span>
													</p>
												</div>
												<hr
													style="border-top-width: 1px; border-color: rgba(0, 0, 0, 0.06);">
											</div>
											<p class="index_care">잦은 야근으로 집에 있는 우리아이 산책이나 미용및 목욕으로
												걱정하시는 분들에게 저희 브이아이펫이 도와드리겠습니다.</p>
										</div>
									</div>
								</div>
									...
									<div class="item_wrap">
										...
										<div class="item_overlay">
											<div class="item_pay">
												<div class="text-table">
													<p>
														<span style="font-size: 22px;"><strong>외부스트레스에
																민감한 노령견을 키우시는 분</strong></span>
													</p>
												</div>
												<hr
													style="border-top-width: 1px; border-color: rgba(0, 0, 0, 0.06);">
											</div>
											<p class="index_care">노령견 같은 경우에는 외부요인에 의해 스트레스가 잘 받기 때문에
												안정감을 느끼는 집에서 케어를 해야 좋습니다.</p>
										</div>
									</div>
								</div>
									...
									<div class="item_wrap">
										...
										<div class="item_overlay">
											<div class="item_pay">
												<div class="text-table">
													<p>
														<span style="font-size: 22px;"><strong>전문샵을
																찾기 힘든 대형견을 키우시는 분</strong></span>
													</p>
												</div>
												<hr
													style="border-top-width: 1px; border-color: rgba(0, 0, 0, 0.06);">
											</div>
											<p class="index_care">몸무게가 많이나가는 대형견 부터 외부에 나가면 예민해지는 아이등
												여러가지 이유로 샵에 가기 어려우신 분들에게 추천합니다.</p>
										</div>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-3 to-animate">
						<div class="fh5co-type">
							...
							<p>가족 같은 마음으로 여러분의 <br> 반려동물을 케어해드립니다.</p>
						</div>
					</div>
					<div class="col-md-3 to-animate">
						<div class="fh5co-type">
					...
					<div class="col-md-3 to-animate">
						<div class="fh5co-type">
							...
							<p>반려동물 케어가 힘들 때, <br> 반려인과 반려동물의 연결고리가 <br>되어드리겠습니다.</p>
						</div>
					</div>
				</div>
			</div>
