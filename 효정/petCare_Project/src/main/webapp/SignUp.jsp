...
<body>
	...
	<form action="signup.do" class="form_join"
		onsubmit="return validateForm()">
		<div class="desktop_join">
			<img src="images/free-icon-dog-3843277.png" id="join_logo" />
			<div class="join_line"></div>
			<div class="join_div">
				<ul>
					<!--  아이디 -->
					<li class="join_list">
						<div class="join_title" id="title_id">
							<!--입력 타이틀 클래스-->
							아이디
						</div> <!--title속성: 마우스 커서 올리면 사용자에게 추가정보 알려줌 -->
						<div class="join_write" title="(영문소문자와 숫자, 4~16자)">
							<input type="text" id="id" name="id" placeholder="" minlength="4"
								maxlength="16" oninput="checkId()" /> <input type="button"
								id="id_confirm" name="id_confirm" onclick="checkDuplicateId()"
								value="아이디 중복체크"><br>
					...
					<!--  비밀번호 -->
					<li class="join_list">
						<div class="join_title" id="title_pw">비밀번호</div>
					...
					<!-- 비밀번호 확인-->
					<li class="join_list">
						<div class="join_title" id="title_confirmpw">비밀번호 확인</div>
						<div class="join_write">
					...
					<!--  이름 -->
					<li class="join_list">
						<div class="join_title" id="title_name">
							<!-- 입력 타이틀 클래스-->
							이름
						</div>
						<div class="join_write" title="">
					...
					<li class="join_list">
						...
						<div class="join_title" id="title_addr">주소</div>
					...
					<!--전화-->
					<li class="join_list ">
						<div class="join_title" id="title_mobile">휴대전화</div>
						<div class="join_write">
							<span class="join-mobile"> <select id="mobile1"
								name="mobile1">
					...
					<!--  이메일 -->
					<li class=" join_list">
						<div class="join_title" id="title_email">이메일</div>
						<div class="join_write">
					...
					<!-- 생일 -->
					<li class="join_list">
						<div class="join_title" id="title_birth">생년월일</div> <input
						type="date" id="birth" name="birth" onblur="checkBirth()">
						<div id="birthError" class="error-message"></div>
					</li>

					<!-- 반려동물  -->
					<!-- 				<li class="join_list"><label>반려동물</label> <input type="radio" -->
				...
				<div class="form_submit">
					<input type="submit" value="회원가입" id="signupbtn" /> <input
						type="button" value="취소" id="cancel" onclick="goToIndex()" />
				</div>
			</div>
		</div>
	</form>
